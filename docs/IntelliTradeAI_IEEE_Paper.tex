...
Three models form the ML ensemble. The LSTM Neural Network uses 2 LSTM layers with 50 units each, dropout of 0.2, and is trained with Adam optimizer. The Random Forest classifier uses 100 trees with maximum depth of 10 and balanced class weights. The XGBoost classifier uses 150 estimators with learning rate of 0.1 and maximum depth of 6.
